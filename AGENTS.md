...
├── tools/build/          # EXE build scripts and spec
├── tools/ffmpeg/         # FFmpeg installation scripts
├── tools/icons/          # Icon generator and guide
├── tools/setup/          # Python environment setup scripts
